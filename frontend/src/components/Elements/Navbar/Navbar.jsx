...
const Navbar = () => {
  ...
  const handleLogout = () => {
    axios
      .delete(`${import.meta.env.VITE_APP_DOMAIN}/logout`, {
  ...
  return (
    <>
      <div className="sticky top-0 z-20 flex h-14 items-center justify-end bg-white px-5 font-montserrat shadow-md">
        <div className="dropdown dropdown-end">
          ...
          >
            <div className="mb-3 flex items-center gap-5 justify-center">
              ...
              <div>
                <h1 className="font-semibold uppercase text-nowrap">{username}</h1>
                <h5 className="text-xs">{getUser.role}</h5>
              </div>
            </div>
            <li>
              <div onClick={() => setModalOpen(true)}>Profil</div>
            </li>
            <li>
